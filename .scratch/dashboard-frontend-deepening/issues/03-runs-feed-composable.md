...
- [x] `useRunsFeed(fetchFn)` owns poll interval, runs, loading, and error state
- [x] `App.vue` consumes the composable rather than managing timers and fetch inline
- [x] A fake `fetchFn` drives the composable in a test (success and error paths)
